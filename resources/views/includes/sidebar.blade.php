<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="{{ asset('/') }}index.html">
        <img class="navbar-brand-dark"  src="{{ asset('/') }}assets/img/logos.png" height="70" width="auto" alt="Volt logo" /> <img
    ...
    <div class="sidebar-inner px-4 pt-3">
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="#" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset('/') }}assets2/img/logos.png" height="50" width="auto"
                            alt="Volt Logo">
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item {{ request()->is('admin/rekap*') ? 'active' : '' }}">
                <a href="{{ route('rekap.index') }}" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            @else
            <li class="nav-item {{ request()->is('Persetujuan/atasan*') ? 'active' : '' }}">
                <a href="{{ route('atasan.index') }}" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
